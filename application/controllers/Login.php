...
class Login extends CI_Controller {
        ...
        public function insert_user()
	{
		...
		$this->form_validation->set_rules('email', 'Email', 'required|is_unique[mock_users.email]');
	...
	$certificate_text=str_replace('{exam_name}',$data['result']['exam_name'],$certificate_text);
