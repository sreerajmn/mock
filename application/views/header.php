	...
	?>
        ...
        <div class="container-fluid">
          <div class="navbar-header">
            ...
            <a class="navbar-brand" href="http://savsoftexam.com"><?php echo $this->lang->line('savsoft_exam');?></a>
          </div>
          <div id="navbar" class="navbar-collapse collapse">
			...
			?>
     		  <li class="dropdown" <?php if($this->uri->segment(1)=='qbank'){ echo "class='active'"; } ?> >
                <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false"><?php echo $this->lang->line('exam');?> <span class="caret"></span></a>
                <ul class="dropdown-menu">
                 <?php  
				if($logged_in['su']==1){
			?>     <li><a href="<?php echo site_url('exam/add_new');?>"><?php echo $this->lang->line('add_new');?></a></li>
              <?php 
				}
?>				 <li><a href="<?php echo site_url('exam');?>"><?php echo $this->lang->line('exam');?> <?php echo $this->lang->line('list');?></a></li>
